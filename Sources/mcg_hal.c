...
{ .mcg_mode = kMcgModeBLPI,       // Work in BLPI mode
      ...
      .frdiv = 0U, .drs = kMcgDcoRangeSelLow,            // Low frequency range
...
void mcg_initOsc0(void)
{
   ...
   { .freq = OSC0_XTAL_FREQ, .hgo = MCG_HGO0, .range = MCG_RANGE0, .erefs =
   MCG_EREFS0, .enableCapacitor2p = OSC0_SC2P_ENABLE_CONFIG,
         .enableCapacitor4p = OSC0_SC4P_ENABLE_CONFIG, .enableCapacitor8p =
         OSC0_SC8P_ENABLE_CONFIG, .enableCapacitor16p =
         OSC0_SC16P_ENABLE_CONFIG, };
...
#error Set RTC_OSC_ENABLE_CONFIG will override OSC0 configuration and OSC0 must be 32k.
   ...
   { .freq = RTC_XTAL_FREQ, .enableCapacitor2p = RTC_SC2P_ENABLE_CONFIG,
         .enableCapacitor4p = RTC_SC4P_ENABLE_CONFIG, .enableCapacitor8p =
         RTC_SC8P_ENABLE_CONFIG, .enableCapacitor16p =
         RTC_SC16P_ENABLE_CONFIG, .enableOsc = RTC_OSC_ENABLE_CONFIG,
